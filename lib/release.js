...
var exports = module.exports = function(opt, callback) {
  ...
  fis.on('process:end', (onProcessEnd = function(file) {
    //20160418,将修改后的html content，覆盖到原来的路径,原来的内容备份为bk文件
    if (fis.project.isCtpProject() && file.isHtmlLike) {
        fis.util.copy(file.origin, file.rest + "_bk" + file.rExt, null, null, true, true);
        fis.util.write(file.origin, file._content);
    }
